defmodule TimeTest do
  ...
  test "with 2 arguments" do
    to_time = Time.now
    from_time = DateTime.shift(DateTime.now, minutes: 65)
    words = TimeAgoWords.diff(DateTime.to_timestamp(from_time), to_time)
    assert words =~ ~r/about 1 hour/
  end
end
